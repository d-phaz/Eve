...
#   "${PROJECT_BINARY_DIR}/git-release" but may be
...
# When running in script mode, source the configuration first
if (CMAKE_SCRIPT_MODE_FILE)
  include("${CMAKE_BINARY_DIR}/git-release-settings.cmake")
endif (CMAKE_SCRIPT_MODE_FILE)

if (NOT CMAKE_SCRIPT_MODE_FILE)
# Version file settings
set(GIT_VERSION_FILE "version.cmake"
...
set(GIT_VERSION_FILE_USE_COMPAT OFF
    CACHE FILEPATH "Create compatibility version file in distributed source tree")
...
function(git_release_version_from_git_tag git_tag tag_exists)
  ...
  string(REGEX REPLACE "^release/${CMAKE_PROJECT_NAME}-([0-9].*)\$" "\\1" git_release_version ${git_tag})
  set(GIT_RELEASE_VERSION ${git_release_version} PARENT_SCOPE)
...
function(git_release_version tag_match)
  if(GIT_RELEASE_ENABLE OR GIT_DIST_ENABLE)
    ...
    if(EXISTS "${PROJECT_SOURCE_DIR}/${GIT_VERSION_FILE}")
      message("Reading release metadata from ${GIT_VERSION_FILE}")
      ...
      message("Reading release metadata from ${GIT_VERSION_FILE_COMPAT}")
        ...
        message("Reading release metadata from git")
...
set(GIT_DIST_TMPDIR ${PROJECT_BINARY_DIR}/git-release
...
function(git_dist_generic)
  ...
  execute_process(COMMAND git add -A -f
...
if (NOT CMAKE_SCRIPT_MODE_FILE)
  ...
  if (GIT_RELEASE_ENABLE OR GIT_DIST_ENABLE)
    ...
    file(WRITE "${CMAKE_BINARY_DIR}/git-release-settings.cmake"
