...
include(${BASE_SOURCE_PATH}/CMake/CleanDirectoryList.cmake)
...
FILE(TO_NATIVE_PATH ${WORKING_DIRECTORY} USERFILE_WORKING_DIRECTORY)
...
"${MULTIWINDOW_BINARY_DIR}/bin/debug/launch-${_targetname}-${_config}.${_suffix}"
@ONLY)
INSTALL(FILES "${MULTIWINDOW_BINARY_DIR}/bin/debug/launch-${_targetname}-${_config}.${_suffix}" DESTINATION bin)
ELSE(BUILD_DEBUG)
configure_file("${_launchermoddir}/targetlauncher.${_suffix}.in"
"${MULTIWINDOW_BINARY_DIR}/bin/release/launch-${_targetname}-${_config}.${_suffix}"
@ONLY)
INSTALL(FILES "${MULTIWINDOW_BINARY_DIR}/bin/release/launch-${_targetname}-${_config}.${_suffix}" DESTINATION bin)
ENDIF(BUILD_DEBUG) 
endforeach()
else()
...
IF(BUILD_DEBUG) 
configure_file("${_launchermoddir}/targetlauncher.${_suffix}.in"
"${MULTIWINDOW_BINARY_DIR}/bin/debug/launch-${_targetname}.${_suffix}"
@ONLY)
INSTALL(FILES "${MULTIWINDOW_BINARY_DIR}/bin/debug/launch-${_targetname}.${_suffix}" DESTINATION bin)
ELSE(BUILD_DEBUG) 
configure_file("${_launchermoddir}/targetlauncher.${_suffix}.in"
"${MULTIWINDOW_BINARY_DIR}/bin/release/launch-${_targetname}.${_suffix}"
@ONLY)
INSTALL(FILES "${MULTIWINDOW_BINARY_DIR}/bin/release/launch-${_targetname}.${_suffix}" DESTINATION bin)
ENDIF(BUILD_DEBUG) 
endif()
endmacro()
