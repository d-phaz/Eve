...
//};
//
//extern void getClippedScaledRects(const Areaf &srcSurfaceBounds, const Rectf &srcRect, const Areaf &dstSurfaceBounds, const Areaf &dstArea, Rectf *resultSrcRect, Areaf *resultDstRect);
