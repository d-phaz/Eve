...
if( ${CMAKE_SIZEOF_VOID_P} EQUAL 8 )
	...
	set( CPACK_PACKAGE_FILE_NAME "${PRODUCT_PRODUCT_NAME}-${CPACK_PACKAGE_VERSION}-x64-Windows" )
	set( CPACK_PACKAGE_INSTALL_REGISTRY_KEY "${PRODUCT_PRODUCT_NAME}-${CPACK_PACKAGE_VERSION}-x64-Windows" )
endif()

if( ${CMAKE_SIZEOF_VOID_P} EQUAL 4 )
	set( CPACK_NSIS_INSTALL_ROOT "$PROGRAMFILES") 
	set( CPACK_PACKAGE_FILE_NAME "${PRODUCT_PRODUCT_NAME}-${CPACK_PACKAGE_VERSION}-x86-Windows")
	set( CPACK_PACKAGE_INSTALL_REGISTRY_KEY "${PRODUCT_PRODUCT_NAME}-${CPACK_PACKAGE_VERSION}-x86-Windows")
endif()
